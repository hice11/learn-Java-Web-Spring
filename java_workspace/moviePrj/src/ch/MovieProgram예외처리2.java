...
public class MovieProgram예외처리2 {
	...
	// 선택 메서드
	private int[] selectInput() throws MyException1 {
		//극장 선택
		String a_ ="1";
		int a=0;
		System.out.println();
		...
		/*
		while (true) {
			if( a <= ScreenData.theaters.length )
				break;
			else {
				System.out.println("\n잘못 입력하셨습니다.");
			}
	...
	public static void main(String[] args) {
		MovieProgram예외처리2 mProgram = new MovieProgram예외처리2();
