...
public class 영화예매프로그램2 {
	...
	char[] ch ;
	private ArrayList<ReservationInfo> reList = new ArrayList<>();
	...
	public 영화예매프로그램2() {}
	public 영화예매프로그램2(int seatNumber) {
	...
	public void movieReservation() {
		...
		if ( seats[row][seatNumber-1] != "X") {
			...
			reservationSeats++;
			list.add(new 영화예매프로그램2(seatNumber));
		}else {
	...
	public void show_ticket() {
		for(int i=0; i<charr.size(); i++) {
			System.out.println(i+1 + ": 예약하신 좌석 : " + charr.get(i) + "열 " + list.get(i) );
		}
	}
