...
<section>
<form action="goods-reg" method="post" id="frm">
  <table>
  <caption>상품 정보 등록</caption>
<%
  int goods_cd = (int)request.getAttribute("goods_cd");
  String sysdate = (String)request.getAttribute("sysdate");
%>
    <tr>
      <td class="center">상품코드</td>
      <td> <input type="text" name="goods_cd" readonly="readonly" value="<%= goods_cd %>"> </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td> <input type="text" name="in_date" readonly="readonly" value="<%= sysdate %>"> </td>
    </tr>
